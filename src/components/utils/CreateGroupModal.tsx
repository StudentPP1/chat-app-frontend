    ...
    return (
        <Modal isOpen={isOpen} setOpen={setOpen}>
            {next
                ...
                :
                <>
                    <h2 className="text-lg font-bold">Enter group name</h2>
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            <input
                                className="bg-black w-full px-3 py-2
                                   border rounded-lg"
                                name="name"
                                value={groupName}
                        ...
                        <button
                            type="submit"
                            className="px-4 py-2 bg-gray-800 hover:bg-gray-600 
